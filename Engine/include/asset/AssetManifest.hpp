...
namespace Leon {
    ...
    public:
        ...
        const std::unordered_map<std::string, FManifestEntry>& GetEntries() const { return m_Entries; }
        std::unordered_map<std::string, FManifestEntry>& GetEntries() { return m_Entries; }

        void Clear() { m_Entries.clear(); }

    private:
        std::unordered_map<std::string, FManifestEntry> m_Entries;
    };
