...
namespace Leon {
    ...
    public:
        ...
        /**
         * @brief Creates an indexed 3D ramp / wedge vertex array (18 vertices, 24 indices).
         * @param InWidth Width along the X axis.
         * @param InHeight Height along the Y axis.
         * @param InDepth Depth along the Z axis.
         */
        static TRef<FVertexArray> CreateRamp(float InWidth = 1.0f, float InHeight = 1.0f, float InDepth = 1.0f);

        /**
         * @brief Creates an indexed 3D square-based pyramid vertex array (16 vertices, 18 indices).
         * @param InWidth Width along the X axis.
         * @param InHeight Height along the Y axis.
         * @param InDepth Depth along the Z axis.
         */
