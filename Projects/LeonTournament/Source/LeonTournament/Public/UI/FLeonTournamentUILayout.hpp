...
namespace Leon {
    ...
    struct FLeonTournamentUILayout : FUILayout {
        ...
        static bool GamepadEdge(int InButton, bool& InOutWasDown) {
            return FUILayout::GamepadEdge(InButton, InOutWasDown);
        }
        ...
        static float SyncResolutionScale(UCanvasPanel& InRoot, float& InOutAppliedScale,
            ...
            return FUILayout::SyncResolutionScale(InRoot, InOutAppliedScale, InOutAppliedViewport,
                                                  InDesignContentHeight, InVerticalMargin);
        }
        ...
        static TRef<UImage> MakePanel(const std::string& InName,
                                      const glm::vec4& InTint = FLeonTournamentUITheme::PanelBg);
