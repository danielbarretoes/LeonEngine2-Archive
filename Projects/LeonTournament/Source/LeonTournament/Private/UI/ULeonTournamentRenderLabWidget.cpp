...
namespace Leon {
    ...
    void ULeonTournamentRenderLabWidget::Build() {
        ...
        ShadowResBtn = MakeButton("RLShadowRes", "CSM: 2048", kFsCaption, btnW, btnH);
    ...
    FGraphicsPreset ULeonTournamentRenderLabWidget::ReadCurrent() const {
        FGraphicsPreset p = FGraphicsQuality::GetPreset(EGraphicsQuality::High);
        auto* gi = GI();
        ...
        p.MaxTextureResolution = FRenderer::GetMaxTextureResolution();
        return p;
    }
