...
namespace Leon::Tools {
    ...
    FCommandRegistry& FCommandRegistry::Get() {
    ...
    int FCommandRegistry::Dispatch(int InArgc, char** InArgv) {
        ...
        if (!cmd) {
            // Check aliases
            if (cmdName == "project")
                cmd = FindCommand("validate_project");
            else if (cmdName == "level")
                cmd = FindCommand("validate_map");
        }
    ...
    void FCommandRegistry::PrintUsage() const {
        std::cout << "===============================================================\n";
        std::cout << " LeonEngine2 Native Asset & Project Tool\n";
        std::cout << "===============================================================\n\n";
        std::cout << "Usage:\n";
        std::cout << "  LeonAssetTool <command> [options]\n\n";
        ...
        std::cout << "  LeonAssetTool <command> --help\n";
        std::cout << "===============================================================\n";
    }
